...
入出力/副作用:
    - 入力: 画像ディレクトリ（sorce/org/image/all_image/**）,
            学習済みモデル（sorce/hyper/model/custom_org.pth）
...
実行例:
    python3 hyper/analysis/gradcam_custom_org_aver.py
"""

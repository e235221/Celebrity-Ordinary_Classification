...
output_base = "/home/student/e21/e215706/dm/sorce/analysis/gradcam_results/average"
model_path = "/home/student/e21/e215706/dm/sorce/model/create/efficientnetb0_looks_classifier.pth"
...
for folder in target_folders:
    ...
    output_path = os.path.join(output_base, f"gradcam_efficientnetb0_average_{folder}.png")
...
output_all_path = os.path.join(output_base, "gradcam_efficientnetb0_average_all.png")
plt.figure(figsize=(6, 6))

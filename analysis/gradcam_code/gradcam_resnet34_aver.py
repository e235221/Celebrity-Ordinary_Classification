...
model_path = "/home/student/e21/e215706/dm/sorce/model/create/resnet34_looks_classifier.pth"
...
for folder in target_folders:
    ...
    output_path = os.path.join(output_base, f"gradcam_resnet34_average_{folder}.png")
...
output_all_path = os.path.join(output_base, "gradcam_resnet34_average_all.png")
plt.figure(figsize=(6, 6))

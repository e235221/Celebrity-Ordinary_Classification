...
model_path = "/home/student/e21/e215706/dm/sorce/model/custom/custom.pth"
...
for folder in target_folders:
    ...
    output_path = os.path.join(output_base, f"gradcam_custom_average_{folder}.png")
...
output_all_path = os.path.join(output_base, "gradcam_custom_average_all.png")
plt.figure(figsize=(6, 6))

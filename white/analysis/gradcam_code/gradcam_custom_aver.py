...
model_path = "/home/student/e21/e215706/dm/sorce/white/model/custom.pth"
...
for folder in target_folders:
    ...
    output_path = os.path.join(output_base, f"gradcam_custom_average_{folder}_white.png")
...
output_all_path = os.path.join(output_base, "gradcam_custom_average_all_white.png")
plt.figure(figsize=(6, 6))

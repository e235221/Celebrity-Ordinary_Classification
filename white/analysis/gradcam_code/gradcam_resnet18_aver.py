...
model_path = models_dir / "resnet18_looks_classifier.pth"
...
for folder in target_folders:
    ...
    out = output_base / f"gradcam_resnet18_average_{folder}.png"
...
out_all = output_base / "gradcam_resnet18_average_all.png"
plt.figure(figsize=(6, 6))

...
model.load_state_dict(torch.load("/home/student/e21/e215706/dm/sorce/model/create/resnet18_looks_classifier.pth", map_location=device))
...
plt.savefig("/home/student/e21/e215706/dm/sorce/analysis/confusion_results/confusion_matrix_resnet18.png")  # 保存path
plt.show()

...
# log path
log_file = '/home/student/e21/e215706/dm/sorce/remove_back/log/resnet50_log.txt'
...
# 8. Model保存
# =======================
torch.save(model.state_dict(), '/home/student/e21/e215706/dm/sorce/remove_back/model/resnet50_looks_classifier.pth')
print("saved model resnet50_looks_classifier.pth")

...
for folder in target_folders:
    ...
    output_path = os.path.join(output_base, f"gradcam_custom_average_{folder}_remove_back.png")
...
output_all_path = os.path.join(output_base, "gradcam_custom_average_all_remove_back.png")
plt.figure(figsize=(6, 6))

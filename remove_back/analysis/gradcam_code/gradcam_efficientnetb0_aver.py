...
model_path = "/home/student/e21/e215706/dm/sorce/remove_back/model/efficientnetb0_looks_classifier.pth"
...
for folder in target_folders:
    ...
    output_path = os.path.join(output_base, f"gradcam_efficientnetb0_average_{folder}_remove_back.png")
...
output_all_path = os.path.join(output_base, "gradcam_efficientnetb0_average_all_remove_back.png")
plt.figure(figsize=(6, 6))
